...
uint256 hashGenesisBlock("0x7ab71bb8666496ddd1c53b78ecf24599399ba2cf9dbdf1872c94736518c0aeb5");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa5133e24dea4d8cedb783a50e798f2fe51932ae44e2fc68efc220822869a05d1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "M.Kemal Ataturk 10 kasim 1938 yilinda vefat etti";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("046edc1641836e49d66d2af904c17183802bdd3e39027360be0f73a2493bacb72430d72ffa8d625fa9445036501640fd9f656103c3c665aaa1394ae105890223cb") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1614104329;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085127830;

        if (fTestNet)
        {
            block.nTime    = 1614104316;
            block.nNonce   = 385856879;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x043d93cf1ea4a65784272823cc651997429ce7443c4f0b61dce0ded486dabac8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfc, 0xc4, 0xbc, 0xd4 }; // Turkcoin: increase each by adding 2 to bitcoin's value.
